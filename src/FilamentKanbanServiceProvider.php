...
namespace Dowhile\FilamentKanban;
...
use Dowhile\FilamentKanban\Commands\MakeKanbanBoardCommand;
use Dowhile\FilamentKanban\Testing\TestsFilamentKanban;
...
class FilamentKanbanServiceProvider extends PackageServiceProvider
{
    ...
    public function configurePackage(Package $package): void
    {
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ->publishAssets()
                    ->askToStarRepoOnGitHub('dowhile-co/filament-kanban');
            });
    ...
    {
        return 'dowhile/filament-kanban';
    }
